...
console.log(`--------------------------
    ...
    myTodoList.push('laundry', 'homework', 'wash car');
    console.log(myTodoList);
    myTodoList.splice(1, 1);
    console.log(myTodoList);
    let yourTodoList = ['clean', 'cook'];
    ...
    let reverse = (x) => {
        if (typeof x === 'boolean') {
            ...
            return x.map(item => reverse(item));
        } else {
            return false;
        }
    }
     ...
     * 
     * ↓ YOUR CODE HERE ↓ */
    let whichArrayIsLonger = (array1, array2) => {
