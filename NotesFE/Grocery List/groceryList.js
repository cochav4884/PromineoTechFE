...
function handleAddClick(event) {
  ...
  completeButton.className =
    'complete-button btn border-2 p-0 d-flex align-items-center justify-content-center';
  ...
  deleteButton.addEventListener('click', () => {
    const deleteIndex = shoppingList.findIndex(
...
// Show the list when the page loads in
function showList() {
